...
from voxcpm.modules.layers.lora import apply_lora_to_named_linear_modules
from voxcpm.modules.locdit import CfmConfig, UnifiedCFM, VoxCPMLocDiT
            ...
            if streaming:
                ...
                if retry_badcase:
                    if pred_audio_feat.shape[0] >= target_text_length * retry_badcase_ratio_threshold:
                        logger.info(f"Badcase detected, audio_text_ratio={pred_audio_feat.shape[0] / target_text_length}, retrying...")
